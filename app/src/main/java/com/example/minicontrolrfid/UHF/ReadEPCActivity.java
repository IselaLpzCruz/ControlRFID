 ...
 */
public class ReadEPCActivity extends UHFBaseActivity implements IAsynchronousMessage {
    ...
    //Codigo RF
    public void ClickBtnRegresarInvExpress(View v){
        finish();
    }
    ...
    protected void Init() {
        ...
        if (!UHF_Init(log)) { // 打开模块电源失败
            ...
            //if (extras != null) {
            //	IdiomaSeleccionado = extras.getString("Idioma");
            //}

            //Hacemos el proceso de Idioma
            //CambiarIdiomaPantalla();
    ...
    protected List<Map<String, Object>> GetData() {
        ...
        synchronized (hmList_Lock) {
            ...
            while (iter.hasNext()) {
                ...
                //dejamos que solo se vean los ultimos 8 digitos
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if ((Adapt.DEVICE_TYPE_HY820 == Adapt.getDeviceType() && (keyCode == KeyEvent.KEYCODE_F9 /* RFID扳机 HY820*/ || keyCode == 285  /* 左快捷*/ || keyCode == 286  /* 右快捷*/))
                || (Adapt.DEVICE_TYPE_HY830 == Adapt.getDeviceType() && keyCode == KeyEvent.KEYCODE_BREAK /* RFID扳机 HY830*/)
